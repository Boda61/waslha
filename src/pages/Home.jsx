...
const steps = [
  {
    ...
    desc: 'اعمل غرفة جديدة وخلي صحابك يدخلوا بكود سهل.',
  },
  {
    emoji: '🕵️',
    title: 'القائد يشوف الصور السرية',
    desc: 'قائد الفريق بس هو اللي يشوف الصورتين السريتين ويعطي تلميح.',
  },
  {
    emoji: '💬',
    title: 'الفريق يناقش ويختار',
    desc: 'فريقك يشوف 4 اختيارات، يناقش في الشات، ويختار إجابة واحدة.',
  },
  {
    emoji: '🏆',
    title: 'أكتر فريق جاوب صح يكسب',
    desc: 'كل إجابة صح بتديك 100 نقطة، والفريق الفايز بياخد بونص.',
  },
];
      ...
      <section className="glass mt-10 flex flex-col items-center gap-4 rounded-2xl p-8 text-center sm:flex-row sm:text-right">
        ...
        <div>
          <h3 className="text-2xl font-extrabold text-gold-300">
            الفريق اللي مش لعب بيبقى مشغول برضه!
          </h3>
          <p className="mt-2 text-slate-300">
            وأثناء ما الفريق التاني شغال، اعمل توقع للإجابة الصح واكسب نقاط زيادة.
            توقع صح = 20 نقطة إضافية 🤑
          </p>
        </div>
      </section>
    </div>
